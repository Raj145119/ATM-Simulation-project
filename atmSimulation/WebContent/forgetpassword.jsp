...
<table width="350">
	...
	<td><input type="text" name="CardNo" placeholder=" card  number"  id="card"></td>
	</tr>
	<tr>
	<td><h5 id="card1">Pin Number:</h5></td>
	<td><input type="password" name="pin" id="pin" placeholder=" pin number"></td>
	</tr>
	<tr>
	...
	<tr>
	<td><a href="forgetPassword2.jsp"><src id="forgetLine">Forget Password ?</src></a></td>
	</tr>
</table>
</form>
</center>
